...
public class BellmanFordSingleSourceShortestPathAlgorithmTest {

    private final 
            BellmanFordSingleSourceShortestPathAlgorithm<DirectedGraphNode>
            algorithm = new BellmanFordSingleSourceShortestPathAlgorithm<>();
